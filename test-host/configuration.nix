...
in
{
  ...
  config = mkMerge [
    ...
    {
      skarabox.hostname = "test-host";
      skarabox.username = "skarabox";
      skarabox.hashedPasswordFile = config.sops.secrets."test-host/user/hashedPassword".path;
      ...
      sops.secrets."test-host/user/hashedPassword" = {
